          ...
          <div className="p-6 space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="flex-1 space-y-2">
                <label className="text-sm font-medium text-gray-300">Base Delivery Fee (Ksh)</label>
                <input 
                  type="number" 
                  defaultValue="200"
                  className="w-full bg-[#0F0F12] border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[#D4A373] transition-colors"
              ...
              <div className="flex-1 space-y-2">
                <label className="text-sm font-medium text-gray-300">Free Delivery Threshold (Ksh)</label>
                <input 
                  type="number" 
                  defaultValue="5000"
                  className="w-full bg-[#0F0F12] border border-white/10 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[#D4A373] transition-colors"
